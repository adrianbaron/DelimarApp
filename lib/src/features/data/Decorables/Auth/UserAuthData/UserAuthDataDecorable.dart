...
UserAuthDataDecorable userAuthDataDecorableFromJson(String str) => UserAuthDataDecorable.fromJson(json.decode(str));

String userAuthDataDecorableToJson(UserAuthDataDecorable data) => json.encode(data.toJson());

class UserAuthDataDecorable {
    List<User> users;

    UserAuthDataDecorable({
        required this.users,
    });

    factory UserAuthDataDecorable.fromJson(Map<String, dynamic> json) => UserAuthDataDecorable(
